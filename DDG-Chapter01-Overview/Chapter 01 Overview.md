...
<img src="Chapter 01 Overview.assets/image-20210206224057731.png" alt="image-20210206224057731" style="zoom:50%;" />
...
<img src="Chapter 01 Overview.assets/image-20210206232540729.png" alt="image-20210206232540729" style="zoom:50%;" />
...
<img src="Chapter 01 Overview.assets/image-20210207190335862.png" alt="image-20210207190335862" style="zoom:67%;" />

:x:Convert curvature from smoot setting directly to discrete is hard/impossible.

<img src="Chapter 01 Overview.assets/image-20210207190928719.png" alt="image-20210207190928719" style="zoom:50%;" />

<img src="Chapter 01 Overview.assets/image-20210207191022358.png" alt="image-20210207191022358" style="zoom:50%;" />
...
<img src="Chapter 01 Overview.assets/image-20210207191446310.png" alt="image-20210207191446310" style="zoom:67%;" />
...
<img src="Chapter 01 Overview.assets/image-20210207193156510.png" alt="image-20210207193156510" style="zoom:67%;" />
...
<img src="Chapter 01 Overview.assets/image-20210208113332805.png" alt="image-20210208113332805" style="zoom:50%;" />
...
<img src="Chapter 01 Overview.assets/image-20210208113543296.png" alt="image-20210208113543296" style="zoom:50%;" />
...
<img src="Chapter 01 Overview.assets/image-20210208120338862.png" alt="image-20210208120338862" style="zoom:50%;" />
...
<img src="Chapter 01 Overview.assets/image-20210208120436678.png" alt="image-20210208120436678" style="zoom:50%;" />
...
<img src="Chapter 01 Overview.assets/image-20210208121106670.png" alt="image-20210208121106670" style="zoom:50%;" />
...
<img src="Chapter 01 Overview.assets/image-20210208122657422.png" alt="image-20210208122657422" style="zoom:50%;" />

in discrete setting, length variation = *discrete* curvature × *discrete* normal($-\kappa^B_i N_i := 2sin(\theta_i/2)N_i$)

<img src="Chapter 01 Overview.assets/image-20210208123154479.png" alt="image-20210208123154479" style="zoom:50%;" />
...
<img src="Chapter 01 Overview.assets/image-20210208123603873.png" alt="image-20210208123603873" style="zoom:50%;" />

Similar from before, for a *constant-distance normal offset*, length will change in ***curved*** regions but not ***flat*** regions

<img src="Chapter 01 Overview.assets/image-20210208124026732.png" alt="image-20210208124026732" style="zoom:50%;" />
...
<img src="Chapter 01 Overview.assets/image-20210208124259078.png" alt="image-20210208124259078" style="zoom:50%;" />
...
<img src="Chapter 01 Overview.assets/image-20210208124739208.png" alt="image-20210208124739208" style="zoom:50%;" />
...
<img src="Chapter 01 Overview.assets/image-20210208130830081.png" alt="image-20210208130830081" style="zoom:80%;" />



Steiner’s formula says **change in length** is *proportional* to **curvature**, hence, the curvature can be denoted as followed:

<img src="Chapter 01 Overview.assets/image-20210208152912134.png" alt="image-20210208152912134" style="zoom:50%;" />
...
<img src="Chapter 01 Overview.assets/image-20210208161533603.png" alt="image-20210208161533603" style="zoom:50%;" />
...
<img src="Chapter 01 Overview.assets/image-20210208164517777.png" alt="image-20210208164517777" style="zoom:50%;" />
...
![curvature-flow](Chapter 01 Overview.assets/curvature-flow.gif)



![curvature-flow1](Chapter 01 Overview.assets/curvature-flow1.gif)
...
<img src="Chapter 01 Overview.assets/image-20210208180418134.png" alt="image-20210208180418134" style="zoom:50%;" />
...
$$
<img src="Chapter 01 Overview.assets/image-20210208181119922.png" alt="image-20210208181119922" style="zoom:50%;" />
...
<img src="Chapter 01 Overview.assets/image-20210208181200654.png" alt="image-20210208181200654" style="zoom:50%;" />
